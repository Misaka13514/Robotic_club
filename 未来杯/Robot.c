...
// 10、读取数据
int GetEE(int addressId) { return 0; }
// 11、拍照
...
int GetAI(int nPort) { return 0; }
int GetGray(int nPort) { return 0; } //灰度
int GetChannelGray(int nPort, int mChannel) { return 0; }
int CheckKey(int nkey) { return 0; }
int GetTouch(int nPort) { return 0; }       //触碰
int GetUltraSonic(int nPort) { return 0; }  //超声
int GetFlame(int nPort) { return 0; }       //火焰
int GetTemperature(int nPort) { return 0; } //温度
int GetMagnet(int nPort) { return 0; }      //磁敏
int GetLight(int nPort) { return 0; }       //光敏
int GetHumidity(int nPort) { return 0; }    //湿度
int GetInfrared(int nPort) { return 0; }    //红外
int GetAngle(int nPort) { return 0; }       //角度
int GetColor(int nPort) { return 0; }       //颜色
//电量百分比
int GetBattery() { return 0; }
//复位运动传感器
void ResetMotionSensor() {}
//获取运动传感器
int GetMotionSensor(int nType, int nAxis) { return 0; }

//复位电机编码器
void ResetEncoder(int encoderId) {}
//获取电机编码器
int GetInstantEncoder(int encoderId) { return 0; }
//获取电机编码器
int GetEncoder(int encoderId) { return 0; }
//复位定时器
void ResetTimer(int timerId) {}
//获取定时器
int GetTimerMS(int timerId) { return 0; }

//设置发送指令
void setSendCmd(int cmd, int index, int value) {}
//获取发送指令
int getSendCmd(int cmd, int index) { return 0; }
//获取接收指令
int getRecvCmd(int cmd, int index) { return 0; }
//获取HID输入
int getHIDValue(int nVauleType) { return 0; }
//电机高级设置
...
// math相关
int iseven(float x) { return 0; }
int isodd(float x) { return 0; }
int isprime(float x) { return 0; }
int isint(float x) { return 0; }
int ispositive(float x) { return 0; }
int isnegative(float x) { return 0; }
int isdivided(float x, float y) { return 0; }
int Random(int mMin, int mMax) { return 0; }
//创建线程/任务
int CreateTask(void *(*mTaskName)(void *), void *arg) { return 0; }

// AI模块
//打开关闭AI识别
void AIOpen(char *type, int mCommand) {}
//获取AI识别结果
char *GetAICode(int nStart, char *AIFileName) { return ""; }
//获取AI识别结果
int GetAIString(int nStart, char *nAIFileName, char *mResult, int mResultSize) {
  return 0;
}
//获取二维码
char *GetQRCode(float nTime) { return ""; }
int GetQRString(float nTime, char *mResult, int mResultSize) { return 0; }
//打印log信息
void LogPrint(const char *format, ...) {}

void Printf(const char *format, ...) {}
int range(int x, int xMin, int xMax) { return 0; }

float rangef(float x, float xMin, float xMax) { return 0; }
